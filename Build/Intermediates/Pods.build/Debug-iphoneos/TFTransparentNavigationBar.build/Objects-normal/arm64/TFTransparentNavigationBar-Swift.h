...
typedef SWIFT_ENUM(NSInteger, TFNavigationBarStyle) {
  TFNavigationBarStyleTransparent = 0,
  TFNavigationBarStyleSolid = 1,
};
...
SWIFT_CLASS("_TtC26TFTransparentNavigationBar22TFNavigationController")
@interface TFNavigationController : UINavigationController <UIBarPositioningDelegate, UINavigationControllerDelegate, UINavigationBarDelegate, UIViewControllerTransitioningDelegate>
- (void)viewDidLoad;
...
SWIFT_PROTOCOL("_TtP26TFTransparentNavigationBar34TFTransparentNavigationBarProtocol_")
@protocol TFTransparentNavigationBarProtocol
